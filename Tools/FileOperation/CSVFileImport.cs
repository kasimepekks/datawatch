...
namespace Tools.FileOperation
{
    public static class CSVFileImport
    {
        ...
        {
            public byte status;//标识数据导入的状态参数，如为0则正常，为1则是文件被占用，为2则是csv文件无数据
            public int columncount;
            public string[] tablehead;
            public string name;
            public string datetime;
        ...
        public static async Task<LoadCSVDataStructforImport> LoadCSVData(FileInfo file,  VehicleIDPara vehicleIDPara)
        {
            ...
            var structforimport=new LoadCSVDataStructforImport()
            {
                ...
                Iscontinue =true,
                boolcan =new List<bool>() {true,true,true,true,true,true,true,true,true,true,true,true,true},//按照顺序依次是time，spd，lat，lon，acczwhllf，acczwhlrf，acczwhllr，accxbody，brakecolumnname，throttlecolumnname，accybody，whlangcolumnname，whlanggrcolumnname
            };
