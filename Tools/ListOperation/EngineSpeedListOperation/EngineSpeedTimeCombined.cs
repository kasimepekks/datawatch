...
{
    public static class EngineSpeedTimeCombined
    {
        /// <summary>
        /// 按30分钟来合并转速时间的数据
        /// </summary>
        ...
        /// <returns></returns>
        public static List<EngineRpmDistribution_Time> engspdtimeCombine(List<EngineRpmDistribution_Time> orlist,string vehicleid)
        {
            if (orlist != null)
            {
               ...
               ).Select(x => new
               {
                ...
                List<EngineRpmDistribution_Time> DListperHalfHourConvert = DListperHalfHour.Select(a => new EngineRpmDistribution_Time
                {
                    Id = a.Id,
