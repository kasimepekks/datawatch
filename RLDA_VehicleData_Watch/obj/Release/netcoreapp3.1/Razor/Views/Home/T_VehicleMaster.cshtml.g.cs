#pragma checksum "D:\VS_Project\SourceCode\data-monitor\RLDA_VehicleData_Watch\Views\Home\T_VehicleMaster.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "1a58c1982cfc9d7dca842ac531497ac6f322328e"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_Home_T_VehicleMaster), @"mvc.1.0.view", @"/Views/Home/T_VehicleMaster.cshtml")]
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"1a58c1982cfc9d7dca842ac531497ac6f322328e", @"/Views/Home/T_VehicleMaster.cshtml")]
    ...
    #nullable restore
    public class Views_Home_T_VehicleMaster : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    #nullable disable
    {
        ...
        {
#nullable restore
#line 1 "D:\VS_Project\SourceCode\data-monitor\RLDA_VehicleData_Watch\Views\Home\T_VehicleMaster.cshtml"
...
#nullable disable
    ...
    <script>
        var user = """);
#nullable restore
#line 27 "D:\VS_Project\SourceCode\data-monitor\RLDA_VehicleData_Watch\Views\Home\T_VehicleMaster.cshtml"
               Write(ViewBag.User);
            ...
            var tableIns = table.render(
                {
                    ...
                    , url: '");
#nullable restore
#line 39 "D:\VS_Project\SourceCode\data-monitor\RLDA_VehicleData_Watch\Views\Home\T_VehicleMaster.cshtml"
                       Write(Url.Action("GetT_VehicleMasterSetup", "Home"));
...
#nullable disable
                WriteLiteral(@"' //数据接口
                    ...
                    , cols: [[ //表头
                        ...
                        ");
                WriteLiteral(@", { field: 'country', title: '国家',  sort: true }
                ...
                if (user == ""Admin"") {
                    if (obj.event === 'edit') {
                        ...
                        layer.open({
                            ...
                            content: '");
#nullable restore
#line 77 "D:\VS_Project\SourceCode\data-monitor\RLDA_VehicleData_Watch\Views\Home\T_VehicleMaster.cshtml"
                                 Write(Url.Action("T_VehicleMaster_PopUp", "PopUp"));
...
#nullable disable
          ...
          ");
                WriteLiteral(@"                          $.ajax({
                                        ...
                                        url: '");
#nullable restore
#line 96 "D:\VS_Project\SourceCode\data-monitor\RLDA_VehicleData_Watch\Views\Home\T_VehicleMaster.cshtml"
                                         Write(Url.Action("AddorEditSingleT_VehicleMaster", "Home"));
...
#nullable disable
                WriteLiteral(@"',
                                        ...
                                        data: {
                                            ...
                                            sta");
                WriteLiteral(@"techeck: iframeEdit.statecheck ? 1 : 0, //显示权限
                                            method: ""edit""
                                        },
                                        //请求成功
                                        success: function (result) {
                                            ...
                                            if (data.samplerate != samplerate || data.numberpoints != numberpoints || data.remarks !=remarkstext) {
                                                $.ajax({
                                                    ...
                                                    url: '");
#nullable restore
#line 119 "D:\VS_Project\SourceCode\data-monitor\RLDA_VehicleData_Watch\Views\Home\T_VehicleMaster.cshtml"
...
#nullable disable
                WriteLiteral(@"',
                                            ...
                                            $.ajax({
                                                ...
                                                url: '");
#nullable restore
#line 130 "D:\VS_Project\SourceCode\data-monitor\RLDA_VehicleData_Watch\Views\Home\T_VehicleMaster.cshtml"
...
#nullable disable
                ...
                WriteLiteral(@"     
                                ...
                                if (data.analysisaccess === 1) {
                                   ...
                                   ");
                WriteLiteral(@" bodyEdit.find('#analysisaccess').removeAttr('checked');
                                }
                        ...
                        layer.confirm('确定删除吗？此操作会删除所有此车辆信息，请谨慎！！！', function (index) {
                            $.ajax({
                                ...
                                url: '");
#nullable restore
#line 207 "D:\VS_Project\SourceCode\data-monitor\RLDA_VehicleData_Watch\Views\Home\T_VehicleMaster.cshtml"
                                 Write(Url.Action("DeleteSingleT_VehicleMaster", "Home"));
            ...
            table.on('toolbar(T_VehicleMaster)', function (obj) {
                ...
                WriteLiteral(@"Admin"") {
                            layer.open({
                                ...
                                content: '");
#nullable restore
#line 240 "D:\VS_Project\SourceCode\data-monitor\RLDA_VehicleData_Watch\Views\Home\T_VehicleMaster.cshtml"
                                     Write(Url.Action("T_VehicleMaster_PopUp", "PopUp"));
...
#nullable disable
                WriteLiteral(@"', //iframe的url
                                ...
                                yes: function (index) {
                                    ...
                                    var numberpoints = bodyEdit.find('#numberpoints').val();
                                    var displaygpspoints = bodyEdit.find('#displaygpspoints').val();
                                    if (vehicleidtext != """" && areatex");
                WriteLiteral(@"t != """" && countrytext != """" && remarkstext != """"
                                        && samplerate != """" && numberpoints != """" && displaygpspoints != """") {
                                        $.ajax({
                                            //请求方式
                                            type: ""POST"",
                                            ...
                                            url: '");
#nullable restore
#line 261 "D:\VS_Project\SourceCode\data-monitor\RLDA_VehicleData_Watch\Views\Home\T_VehicleMaster.cshtml"
                                             Write(Url.Action("AddorEditSingleT_VehicleMaster", "Home"));
...
#nullable disable
 ...
 ");
                WriteLiteral(@"                                               statecheck: iframeAdd.statecheck ? 1 : 0,
                                                method: ""add""
                                            },
                                            //请求成功
                                            success: function (result) {
               ...
               ");
                WriteLiteral(@"                     }
                        ...
                        break;
   ");
                WriteLiteral("                 case \'ReloadData\':\r\n                        tableIns.reload({\r\n                            page: { curr: 1, limit: 30 },\r\n                            url: \'");
#nullable restore
#line 315 "D:\VS_Project\SourceCode\data-monitor\RLDA_VehicleData_Watch\Views\Home\T_VehicleMaster.cshtml"
                             Write(Url.Action("GetT_VehicleMasterSetup", "Home"));
